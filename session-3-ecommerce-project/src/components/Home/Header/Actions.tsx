...
function Actions() {
  ...
  return (
    <div className="tw:flex tw:gap-3.5 tw:items-center">
      <svg
        width="30px"
        height="30px"
        viewBox="0 0 24 24"
      ...
      >
        {totalQuantity !== 0 && (
          <div className="tw:absolute tw:right-[-10px] tw:top-[-19px] tw:text-white tw:bg-blue-500 tw:px-1.5 tw:rounded-[200px] ">
            {totalQuantity}
          </div>
        )}
        <svg
